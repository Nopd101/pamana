...
export default function Home() {
  return (
    <div className="bg-[#f6efe6] text-[#3b2a1a]">
      ...
      {/* HERO SECTION */}
      <div className="relative h-screen bg-cover bg-center flex items-center justify-center before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-[url('/src/assets/main-home-bg.png')] before:bg-cover before:bg-center before:opacity-50 before:z-0">
        <div className="absolute top-0 left-0 w-full h-full bg-[#f1f1f111] z-[1]"></div>
        <AnimatedElement
          className="relative z-[2] text-center p-4 md:p-12"
          animation="fadeInUp"
        >
          ...
          <p className="text-sm md:text-xl mt-4 md:mt-6 text-black font-medium tracking-[0.1em] md:tracking-[0.12em] text-shadow-[0_5px_5px_rgba(0,0,0,0.596)] text-center">
      ...
      <div className="shadow-[0_-10px_30px_rgba(0,0,0,0.5)] bg-[#f6efe6]">
        <div className="relative py-12 md:py-18 overflow-hidden">
          <AnimatedElement animation="slideInLeft">
            <img src={characterLeft} alt="" className="hidden md:block absolute left-[-120px] top-[-130px] h-[600px] w-auto z-[1] opacity-90 transform rotate-45" />
          </AnimatedElement>
          <AnimatedElement animation="slideInRight" style={{ animationDelay: "0.1s" }}>
            <img src={characterRight} alt="" className="hidden md:block absolute right-[-120px] top-[-50px] h-[600px] w-auto z-[1] opacity-90 transform -rotate-45" />
          </AnimatedElement>
