      ...
      <div className="min-h-screen bg-cover bg-center p-4 pt-10" style={{ backgroundImage: `url(${bgHome})` }}>
        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col items-center mt-24 md:mt-10">
          <div className="text-center mb-6 px-4">
            <h1 className="text-3xl md:text-5xl font-extrabold text-[#7B3306] font-[var(--font-heading)] uppercase drop-shadow-sm">HARAPPUZZLE QUEST</h1>
            <p className="text-[#B06A3A] font-bold text-lg mt-2">Assemble the pieces to reveal a part of history!</p>
          </div>
