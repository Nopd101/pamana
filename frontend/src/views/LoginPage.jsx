...
function LoginPage() {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl h-[550px] bg-[#3E2b26] rounded-[40px] shadow-2xl flex overflow-hidden mx-4">
        <div
        ...
        >
          <img
            src={leftSideImage}
            alt="Left Pattern"
            className="absolute top-22 right-25 w-[80%] object-contain opacity-50 grayscale"
          />

          <img
            src={leftSide2Image}
            alt="Right Pattern"
            className="absolute bottom-25 right-0 w-[80%] object-contain opacity-50 grayscale translate-x-4 translate-y-4"
          />
        </div>
